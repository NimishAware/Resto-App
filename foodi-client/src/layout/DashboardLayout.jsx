...
const DashboardLayout = () => {
  ...
  return (
    ...
    </div> : (loading ? <Login/> : <div className="h-screen flex flex-col justify-center items-center">
      <h2>This page is only for Admin</h2><br></br>
      <Link to="/"><button className="btn bg-green text-white">Back to Home</button></Link>
      </div>)
    }
    </div>
  );
